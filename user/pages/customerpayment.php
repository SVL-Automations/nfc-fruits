...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT p.*,DATE_FORMAT(p.date,'%d/%m/%Y') AS niceDate, 
                                        c.name as customername, c.mobile as customermobile FROM `customer_payment` as p                                         
...
if (isset($_POST['Add'])) {
    ...
    $res = mysqli_query($connection, "INSERT INTO `customer_payment`(`customerid`, `date`, `amount`, `mode`, `details`, `updatedby`,`status`)                                           
...
if (isset($_POST['delete'])) {
    ...
    $res = mysqli_query($connection, "UPDATE `customer_payment` SET `status`= 0 where id = '$id'");

    if ($res > 0) {
        $msg->value = 1;
        $msg->data = "Received Amount Deleted Successfully.";
        $msg->type = "alert alert-success alert-dismissible ";
    } else {
        $msg->value = 0;
...
<head>
    ...
    <title><?= $project ?> : Customer Received Payment</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Customer Received Payment Details </h3>
                                <a class="btn btn-social-icon btn-success pull-right" title="Add Customer Payment" data-toggle="modal" data-target="#modaladdrbill"><i class="fa fa-plus"></i></a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-green">
                            ...
                            <h4 class="modal-title">Add Customer Received Payment Details</h4>
                        </div>
                        ...
                        <div class="modal-footer ">
                            ...
                            <button type="submit" name="Add" value="Add" id='add' class="btn btn-success">Add Customer Payment</button>
        ...
        <!-- End Add Received bill modal -->
         ...
         <form id="generatepurchasebill" action="customerbillprint.php" method="get">
