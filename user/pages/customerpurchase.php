...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT p.*,DATE_FORMAT(p.date,'%d/%m/%Y') AS niceDate,
                                        v.name as vehiclename, v.number as vehiclenumber, 
                                        c.name as customername, c.mobile as customermobile from customer_purchase as p
    ...
    $result = mysqli_query($connection, "Select id,name,number from vehicle where status='1' order by name");
    $data->vehiclelist = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
if (isset($_POST['Add'])) {
    ...
    $msg = new \stdClass();
    $customerid = mysqli_real_escape_string($connection, $_POST['customer']);
    ...
    $vehicleamount = mysqli_real_escape_string($connection, $_POST['vehicleamount']);

    $created = date("Y-m-d H:i:s");
    $updated = date("Y-m-d H:i:s");

    $res = mysqli_query($connection, "INSERT INTO `customer_purchase`(`customerid`, `date`, `carate`, `weight`, 
                                    `totalweight`, `discount`, `actualweight`, `type`, `rate`, 
                                    `totalamount`, `vehicleid`, `vehiclepayment`, `status`, `time`)
                                    VALUES('$customerid','$date','$caret','$weight',
                                            '$totalweight','$discount','$actualweight','$type','$rate',
                                            '$totalamount','$vehicle','$vehicleamount','1','$updated')
                                    ");
    if ($res > 0) {
        $msg->value = 1;
...
if (isset($_POST['delete'])) {
    ...
    $res = mysqli_query($connection, "UPDATE `customer_purchase` SET status=0 WHERE id = '$id'");
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <a class="btn btn-social-icon btn-success pull-right" title="Add Sales" data-toggle="modal" data-target="#modaladdsales"><i class="fa fa-plus"></i></a>
                                <a class="btn btn-social-icon btn-warning pull-right" title="Generate Bill" data-toggle="modal" data-target="#modalsalesbill" style="margin-right: 5px !important;"><i class="fa fa-file-excel-o"></i></a>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Custmer Name </label>
                                <select class="form-control select2 select3" style="width: 100%;" required name="customer" id="customer">
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <option value="Supar sonaka">Supar sonaka</option>
                                <option value="Anuska">Anuska</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select3" style="width: 100%;" required name="vehicle" id="vehicle">
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Vehicle Amount</label>
                                <input type="number" step="any" class="form-control" placeholder="Vehicle Amount" name="vehicleamount" id="vehicleamount" required min="0" value="0">
                            </div>

                        </div>
                        <div class="modal-footer ">
                            <input type="hidden" name="Add" value="Add">
                            <button type="submit" name="Add" value="Add" id='add' class="btn btn-success">Add Sales</button>
        ...
        <form id="generatesalesbill" action="customerbillprint.php" method="get">
            <div class="modal fade" id="modalsalesbill" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-green">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            function tabledata() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#vehicle').append(new Option("Select vehicle", ""));
                        $.each(returnedData['vehiclelist'], function(key, value) {
                            $('#vehicle').append(new Option(value.name, value.id));                            
                        });
