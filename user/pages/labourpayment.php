...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT p.*,DATE_FORMAT(p.date,'%d/%m/%Y') AS niceDate, 
                                        f.name as labourname, f.mobile as labourmobile FROM `labour_vendor_payment` as p                                         
...
if (isset($_POST['Add'])) {
    ...
    $res = mysqli_query($connection, "INSERT INTO `labour_vendor_payment`(`labourvendorid`, `date`, `amount`, `mode`, `details`, `updatedby`,`status`)                                           
...
if (isset($_POST['delete'])) {
    ...
    $res = mysqli_query($connection, "UPDATE `labour_vendor_payment` SET `status`= 0 where id = '$id'");
...
<head>
    ...
    <title><?= $project ?> : Labour Vendor Send Payment</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Labour Vendor Payment Details </h3>
                                <a class="btn btn-social-icon btn-success pull-right" title="Add Labour Vendor Payment" data-toggle="modal" data-target="#modaladdrbill"><i class="fa fa-plus"></i></a>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class='text-center'>Labour Vendor Name </th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-green">
                            ...
                            <h4 class="modal-title">Add Labour Vendor Payment Details</h4>
                        </div>
        ...
        <!-- End Add Received bill modal -->
         ...
         <form id="generatepurchasebill" action="labourpaymentprint.php" method="get">
                    ...
                    success: function(response) {
                        ...
                        $.each(returnedData['list'], function(key, value) {
                            ...
                            button1 = '<button type="submit" name="Delete" id="Delete" ' +
                                ...
                                '" class="btn btn-xs btn-danger delete-button" style= "margin:5px" title=" Delete Payment"><i class="fa fa-times"></i></button>';
