...
if (isset($_POST['Add'])) {
    ...
    $vehicleid = mysqli_real_escape_string($connection, $_POST['vehicle']);
    $type = mysqli_real_escape_string($connection, $_POST['type']);
    $amount = mysqli_real_escape_string($connection, $_POST['amount']);
    $remark = mysqli_real_escape_string($connection, $_POST['remark']);
    $date = mysqli_real_escape_string($connection, $_POST['date']);

    $res = mysqli_query($connection, "INSERT INTO `vehicle_payment`(`vehicleid`, `date`, `amount`, `mode`, `details`, `updatedby`,`status`)                                           
                                    VALUES('$vehicleid','$date','$amount','$type', '$remark','$userid','1')
                                    ");
    if ($res > 0) {
        $msg->value = 1;
        $msg->data = "Paid Amount Added Successfully";
...
if (isset($_POST['delete'])) {
    ...
    $res = mysqli_query($connection, "UPDATE `vehicle_payment` SET `status`= 0 where id = '$id'");

    if ($res > 0) {
        $msg->value = 1;
        $msg->data = "Paid Amount Deleted Successfully.";
        $msg->type = "alert alert-success alert-dismissible ";
    } else {
        $msg->value = 0;
...
<head>
    ...
    <title><?= $project ?> : Vehicle Paid Payment</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Vehicle Paid Payment Details </h3>
                                <a class="btn btn-social-icon btn-success pull-right" title="Add Vehicle Payment" data-toggle="modal" data-target="#modaladdrbill"><i class="fa fa-plus"></i></a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-green">
                            ...
                            <h4 class="modal-title">Add Vehicle Paid Payment Details</h4>
                        </div>
                        ...
                        <div class="modal-footer ">
                            ...
                            <button type="submit" name="Add" value="Add" id='add' class="btn btn-success">Add Payment</button>
        ...
        <!-- End Add Received bill modal -->
         ...
         <form id="generatepurchasebill" action="vehiclepaymentprint.php" method="get">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select3" style="width: 100%;" required name="vehicleid" id="vehicleid">
                                </select>
                            </div>
                    ...
                    success: function(response) {
                        ...
                        $.each(returnedData['list'], function(key, value) {
                            ...
                            button1 = '<button type="submit" name="Delete" id="Delete" ' +
                                ...
                                '" class="btn btn-xs btn-danger delete-button" style= "margin:5px" title=" Delete Paid Bill"><i class="fa fa-times"></i></button>';
                        ...
                        $('.select3').append(new Option("Select vehicle", ""));
                        $.each(returnedData['vehiclelist'], function(key, value) {
                            $('.select3').append(new Option(value.name+' ( '+value.number+' )', value.id));
                        });
