...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT p.*,DATE_FORMAT(p.date,'%d/%m/%Y') AS niceDate, 
                                        f.name as labourname, f.mobile as labourmobile from labour_vendor_work as p
                                            LEFT join labour_vendor as f ON p.labourvendorid = f.id
                                            WHERE p.status = 1
                                            order by p.date desc ");
    $data->list = mysqli_fetch_all($result, MYSQLI_ASSOC);

    $result = mysqli_query($connection, "Select id,name from labour_vendor where status='1' order by name");
    $data->labour_vendorlist = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
if (isset($_POST['Add'])) {
    ...
    if ($res > 0) {
        $msg->value = 1;
        $msg->data = "Labour Work Added Successfully.";
...
if (isset($_POST['delete'])) {
    ...
    $res = mysqli_query($connection, "UPDATE `labour_vendor_work` SET status=0 WHERE id = '$id' ");

    if ($res > 0) {
        $msg->value = 1;
        $msg->data = "Labour Work Deleted Successfully.";
        $msg->type = "alert alert-success alert-dismissible ";
    } else {
        $msg->value = 0;
...
<head>
    ...
    <title><?= $project ?> : Add Labour Work Details</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"> Labour Work Details </h3>
                                <a class="btn btn-social-icon btn-success pull-right" title="Add Labour Work" data-toggle="modal" data-target="#modaladdwork"><i class="fa fa-plus"></i></a>
                                <a class="btn btn-social-icon btn-warning pull-right" title="Generate Bill" data-toggle="modal" data-target="#modalworkbill" style="margin-right: 5px !important;"><i class="fa fa-file-excel-o"></i></a>
                            </div>
        ...
        <!-- /.content-wrapper -->
        <!-- Add  work modal -->
        <form id="addwork" action="" method="post">
            <div class="modal fade" id="modaladdwork" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-green">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span></button>
                            <h4 class="modal-title">Add Labour Work Details</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Gents</label>
                                <input type="number" class="form-control" placeholder="Total Gents" name="gents" id="gents" required min="0" value="0">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" placeholder="Enter Location" name="location" id='location' required></textarea>
                            </div>
                        ...
                        <div class="modal-footer ">
                            ...
                            <button type="submit" name="Add" value="Add" id='add' class="btn btn-success">Add Work</button>
        ...
        <form id="generatepurchasebill" action="labourbill.php" method="get">
                    ...
                    success: function(response) {
                        ...
                        $.each(returnedData['list'], function(key, value) {
                            ...
                            button1 = '<button type="submit" name="Delete" id="Delete" ' +
                                ...
                                '" class="btn btn-xs btn-danger delete-button" style= "margin:5px" title=" Delete Work Details" ><i class="fa fa-times"></i></button>';
