...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT s.*,DATE_FORMAT(s.date,'%d/%m/%Y') AS niceDate, c.name as customername, c.mobile as customermobile from sales as s
                                            LEFT join customer as c ON s.customerid = c.id
                                            WHERE s.status = 1 AND s.date <='$endDate' AND s.date>='$startDate'
...
if (isset($_POST['Add'])) {
    ...
    $msg = new \stdClass();
    $vendorid = mysqli_real_escape_string($connection, $_POST['customerid']);
    ...
    $res = mysqli_query($connection, "INSERT INTO `sales`(`customerid`, `date`, `total` ,
                                                            ...
                                                            `discount`,  `lastupdateby`, `status`)
                                    VALUES('$vendorid','$date','$total',
...
if (isset($_POST['delete'])) {
    ...
    $res = mysqli_query($connection, "UPDATE `sales` SET status = 0 WHERE id = '$id' ");
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <button type="button" class="btn btn-default pull-right" id="daterange-btn" style="margin-right: 5px !important;">
                                            <span>
        ...
        <!-- Add  sales modal -->
        <form id="generatesalesbill" action="salesbill.php" method="get">
    ...
    <script>
        $(document).ready(function() {
            var startDate1=new Date('YYYY-MM-DD');
            var endDate1=new Date('YYYY-MM-DD');
                    ...
                    success: function(response) {
                        ...
                        $.each(returnedData['list'], function(key, value) {
                            ...
                            button2 = '<a ' +
                                ...
                                '" class="btn btn-xs btn-success view-button" style= "margin:5px" title=" View Sales bill"  href="rptsalesbill.php?id=' + value.id + '" ><i class="fa fa-eye"></i></a>';
